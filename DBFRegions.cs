...
namespace KMZ_Viewer
{
    ...
    public class PointInRegionUtils
    {
        ...
        public int LoadRegionsFromFile()
        {
            ...
            string shpFile = String.Format(@"{0}\{1}", KMZViewerForm.CurrentDirectory(), ShapeFileName);
            ...
            {
                string dbfFile = String.Format(@"{0}\{1}", KMZViewerForm.CurrentDirectory(), ShapeDBFName);
